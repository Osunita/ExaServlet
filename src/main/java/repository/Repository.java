...
public class Repository {
	...
	public duenos search(duenos duenoFormulario) {
		...
		try {
			...
			prepareStatement.setString(1, duenoFormulario.getNombreDueño());
	...
	public void insert(duenos userFormulario) {
		...
		try {
			...
			preparedStatement.setString(1, userFormulario.getNombreDueño());
	...
	public void update(duenos userFormulario) {
		...
		try {
			...
			preparedStatement.setString(1, userFormulario.getNombreDueño());
			preparedStatement.setString(2, userFormulario.getNombreDueño());
